...
function ProjectCategoryItem(props: ComponentProps) {
  ...
  return (
    <a href={`/project/${props.category.id}`}>
      <div className="relative h-full group rounded-2xl bg-no-repeat bg-cover py-24 cursor-pointer md:py-14 lg:py-28"
        ...
        <div className="absolute left-0 right-0 top-0 bottom-0 bg-grey-dark opacity-70 rounded-2xl duration-500 transition-all group-hover:bg-peach"></div>
      </div>
    </a>
  )
}
